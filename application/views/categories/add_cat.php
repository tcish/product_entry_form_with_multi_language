    ...
    <div class="row">
      <div class="col-12 col-sm-8 col-md-6 col-lg-5 offset-sm-2 offset-md-3 offset-lg-3">
        <div class="shadow-lg p-4">
          <h1 class="text-center mb-3 pb-1 custom__border text-info"><?= $this->lang->line("add_cat_title"); ?></h1>
          <form autocomplete="off" method="post" enctype="multipart/form-data">
            <div class="form-group">
              <label class="font-weight-bold" for=""><?= $this->lang->line("cat_name"); ?>:</label>
              <input type="text" class="form-control" name="category" placeholder="<?= $this->lang->line("cat_name_placeholder"); ?>" value="<?php echo set_value("category"); ?>">
