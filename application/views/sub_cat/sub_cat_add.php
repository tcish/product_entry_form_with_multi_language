    ...
    <div class="row">
      <div class="col-12 col-sm-8 col-md-6 col-lg-5 offset-sm-2 offset-md-3 offset-lg-3">
        <div class="shadow-lg p-4">
          <h2 class="text-center mb-3 pb-1 custom__border text-info"><?= $this->lang->line("add_sub_cat_title"); ?></h2>
          <form autocomplete="off" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="sub_category" placeholder="<?= $this->lang->line("sub_cat_name_placeholder"); ?>" value="<?php echo set_value("sub_category"); ?>">
